...
from models.pbpk_aorta_liver import TwoScan as ModelOneDose
from models.pbpk_aorta_liver_ns import TwoScan as ModelTwoDose
...
def main():
    ...
    resultspath = os.path.join(results, 'pbpk_aorta_liver_2scan')
