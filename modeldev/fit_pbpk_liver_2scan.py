...
from models.pbpk_liver import TwoScan as ModelOneDose
from models.pbpk_liver_ns import TwoScan as ModelTwoDose
...
def fit(data, aorta):
    ...
    result = liver_model(
        ...
        R1molli = np.array([1000.0/data['T1liver1'], 1000.0/data['T1liver3']]),
...
def main():
    ...
    resultspath = os.path.join(results, 'pbpk_liver_2scan')
