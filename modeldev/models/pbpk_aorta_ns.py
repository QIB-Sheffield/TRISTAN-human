...
class Model(lib.FitFunc):
    ...
    def pars(self):
        return [
            ...
            ['E_bi',"Body extraction fraction", 0.025,"", 0.01, 0.15, True, 4],
            ['E_bf',"Body extraction fraction", 0.025,"", 0.01, 0.15, True, 4],
        ]
    ...
    def plot_conc_fit(self, ax2, xlim, legend):
        ...
        ax2.plot(t, self.cb, 'b-', label='Aorta')
        if legend:
            ax2.legend()
