...
class Model(lib.FitFunc):
    ...
    def predict_R1(self):
        ...
        Np = dcmri.res_plug(t, J_kidneys, p.Tv) 
        #Np = dcmri.ures_chain(t[1]-t[0], J_kidneys, p.Tv, p.Dv)
        ...
        # Return R
        rp = lib.rp(self.field_strength, self.agent)
    ...
    def pars(self):
        return [
            ...
            #['Dv',"Vascular dispersion", 50.0,"%", 5, 95, True, 6],
    ...
    def export_pars(self, export_pars):
        p = self.p.value
        export_pars.drop(['h0','h1','h2','h3','h4','h5'], inplace=True)
        ...
        #TTdesc = dcmri.res_free_desc(self.tmax, H, TTmax=self.tmax-self.BAT)
        ...
        export_pars.loc['MTTt'] = ["Tubular MTT", TTdesc['mean']/60, 'min']
        export_pars.loc['TTDt'] = ["Tubular transit time dispersion", 100*TTdesc['stdev']/TTdesc['mean'], '%']
        return export_pars
